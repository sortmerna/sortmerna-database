...
def main():
  ...
  html = (
    ...
    "      <p>Sequence counts per source database and taxonomic domain across all clustering thresholds.</p>\n"
    f"      {versions_html}\n"
    "    </div>\n"
    ...
    + (
      ...
      "file by converting lowercase bases to N. "
      "Each cell shows the number of sequences with at least one soft-masked nucleotide out of "
      "the total sequences in that group (masked/total), with the percentage of masked sequences "
      "shown above.</p>\n"
      "</div>\n"
      "<div class=\"table-wrap\">\n"
