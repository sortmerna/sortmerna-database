...
def main():
  ...
  html = (
    ...
    "    <p class=\"subtitle\">Sequence counts after CD-HIT clustering at multiple identity thresholds</p>\n"
    ...
    "      <ul>\n"
    "        <li><b>%clust</b> — identity threshold used for CD-HIT clustering</li>\n"
